/*
 *  drivers/cpufreq/cpufreq_madness.c
 *
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_MADNESS
static
#endif
struct cpufreq_governor cpufreq_gov_madness = {
	.name			= "madness",
...
MODULE_DESCRIPTION("'cpufreq_madness' - A dynamic cpufreq governor for "
		"Low Latency Frequency Transition capable processors "
		"optimised for use in a battery environment");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_MADNESS
